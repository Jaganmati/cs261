...
public:
	...
	static	void	StaticInit( const SocketAddress& inServerAddress, const string& inAccountId, const string& inName, const string& inAvatar, const string& inToken );
...
private:
			...
			void Init( const SocketAddress& inServerAddress, const string& inAccountId, const string& inName, const string& inAvatar, const string& inToken );
